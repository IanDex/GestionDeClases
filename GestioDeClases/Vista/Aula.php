                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-header ian">
                            <h4 class="title">Registro de Aula</h4>
                        ...
                        <div class="card-content">
                            <form>
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group label-floating">
                                            ...
                                            <input id="Numero" name="Numero" type="number" min="0" class="form-control" >
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Capacidad</label>
                                            <input id="Cap" name="Cap" type="number" min="0" class="form-control" >
                                        </div>
                                    </div>
                                ...
                                <div class="form-group label-floating">
                                    ...
                                    <button style="margin-bottom: 10px" type="submit" class="btn btn-primary btn-round right" name="send" id="send">Enviar</button>
