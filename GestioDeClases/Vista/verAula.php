...
<div style="background: white; padding: 15px; border-radius: 10px">
    ...
    <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
        <form class="col s12" method="post" action="../Controlador/Aul.php?action=crear">

        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Registrar Aulas</h4>
                </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input name="Numero" type="number" min="0" class="form-control" placeholder="Numero" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input name="Cap" type="number"min="0" class="form-control" placeholder="Capacidad" />
                                    </div>
                                </div>
                                <div class="form-group label-floating">
                                    <select id="Estado" name="Estado" class="form-control show-tick">
...
<script>
    ...
    function tableData(){
        $('#mytable').Tabledit({
            ...
            columns: {
                identifier: [0, 'id'],
                editable: [[1, 'name'],[2, 'Numer'],[3, 'Cap'],[4, 'Esta']]
            },
