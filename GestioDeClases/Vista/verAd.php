...
<?php if(!empty($_GET['respuesta'])){ ?>
    <?php if ($_GET['respuesta'] == "1"){ ?>
        <script>
            ...
            $.notify({
                title: '<strong>Adminintrador</strong>',
...
<div style="background: white; padding: 15px; border-radius: 10px">
    ...
    <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
        <form class="col s12" method="post" action="../Controlador/AdminCtlr.php?action=crear">

        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Registrar Administrador</h4>
                </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input name="Tel" type="text" class="form-control" placeholder="Telefono" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-line">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input name="Obser" type="text" class="form-control" placeholder="Observaciones" />
                                    </div>
                                </div>
                            </fieldset>
                        </div>
...
<script>
    ...
    function tableData(){
        $('#mytable').Tabledit({
            ...
            columns: {
                identifier: [0, 'id'],
                editable: [[1, 'name'],[2, 'Apel'],[3, 'Tip'],[4, 'Dc'],[5, 'Te'],[6, 'ema'],[7, 'Ob']]
            },
