...
<div style="background: white; padding: 15px; border-radius: 10px">
    ...
    <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
        <form class="col s12" method="post" action="../Controlador/ProgramaCtlr.php?action=crear">

        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Registrar Programa</h4>
                </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input name="C_min" type="number" min="0" class="form-control" placeholder="Cantidad Minima"required />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input name="C_max" type="number" min="0" class="form-control" placeholder="Cantidad Maxima" required />
                                    </div>
                                </div>
