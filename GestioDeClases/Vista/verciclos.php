...
<div style="background: white; padding: 15px; border-radius: 10px">
    ...
    <form class="navbar-form navbar-right" role="search" method="post">
        <div class="form-group  is-empty">
            <button type="button" data-color="red" class="btn bg-pink btn-round btn-just-icon waves-effect" data-toggle="modal" data-target="#defaultModal">
                <i class="material-icons">more</i><div class="ripple-container"></div>
            </button>

            <input type="text" name="bcr" class="form-control" placeholder="Buscar...">
